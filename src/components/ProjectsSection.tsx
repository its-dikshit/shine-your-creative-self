...
const ProjectsSection = () => (
  <section id="projects" className="max-w-6xl mx-auto my-20 px-6">
    <h2 className="text-3xl font-bold mb-10 text-black dark:text-transparent dark:bg-clip-text dark:bg-gradient-to-r dark:from-[#9dabf7] dark:via-[#677ade] dark:to-[#386ec9]">
      Projects
    </h2>
    <div className="grid md:grid-cols-3 gap-8">
      {projects.map((project, idx) => (
        <a
          ...
          className="bg-card dark:bg-gradient-to-br dark:from-[#181e32] dark:via-[#232d48] dark:to-[#253356] rounded-xl overflow-hidden shadow-lg group hover-scale transition-all duration-200 animate-fade-in flex flex-col border border-gray-100 dark:border-slate-800"
        >
          <img
            src={project.image}
            alt={project.title}
          ...
          <div className="p-6 flex-1 flex flex-col justify-between">
            <h3 className="text-xl font-semibold mb-2 text-black dark:text-transparent dark:bg-clip-text dark:bg-gradient-to-r dark:from-[#95b0f6] dark:to-[#6179db]">
              {project.title}
            </h3>
            <p className="text-muted-foreground mb-4 flex-1 dark:text-gray-300">{project.description}</p>
            <span className="mt-auto text-primary font-medium underline-offset-2 group-hover:underline dark:bg-gradient-to-r dark:from-[#73a4e7] dark:to-[#546b9f] dark:bg-clip-text dark:text-transparent">
              View Project &rarr;
            </span>
          </div>
        </a>
