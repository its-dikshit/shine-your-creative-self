...
const DesktopSidebarToggleButton: React.FC = () => {
  ...
  return (
    <button
      className="absolute left-2 top-4 z-20 md:flex hidden items-center justify-center w-8 h-8 rounded-full bg-gradient-to-tr from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 shadow-lg text-white transition-all duration-200 border-2 border-white dark:border-neutral-800 focus:outline-none focus:ring-2 focus:ring-blue-300"
...
const Sidebar: React.FC<SidebarProps> = ({ scrollRef }) => {
  ...
  return (
    <>
      {/* Desktop sidebar: collapsible, 20vw width */}
      <ShadcnSidebar
        className="hidden md:block"
        collapsible="offcanvas"
        side="left"
      >
        <div className="h-screen w-[20vw] min-w-[160px] max-w-[300px] bg-[#f5f7fa] dark:bg-sidebar text-sidebar-foreground border-r border-sidebar-border transition-colors flex-col items-center relative flex">
