...
const ExtraCurricularSection = () => (
  <section id="extracurricular" className="max-w-5xl mx-auto py-20 px-4">
    <h2 className="text-3xl sm:text-4xl font-bold mb-1 text-black dark:text-transparent dark:bg-clip-text dark:bg-gradient-to-r dark:from-[#232943] dark:via-[#382a6d] dark:to-[#673ab7] font-playfair">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-7">
      {activities.map((a, i) => (
        <div key={i} className="rounded-2xl bg-gray-50 dark:bg-gradient-to-br dark:from-[#232943] dark:via-[#382a6d] dark:to-[#673ab7] border border-gray-200 dark:border-slate-800 px-6 py-6 flex flex-col shadow-sm min-h-[140px] transition-all">
          <div className="flex flex-row items-center gap-3 mb-2">
            <span className="text-2xl sm:text-2xl">{a.icon}</span>
            <span className="text-lg font-bold text-black dark:text-transparent dark:bg-clip-text dark:bg-gradient-to-r dark:from-[#858fe6] dark:via-[#a693f9] dark:to-[#673ab7]">{a.title}</span>
          </div>
